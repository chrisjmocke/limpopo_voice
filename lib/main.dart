...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  Column(
                    children: [
                      ...
                      IconButton(
                        ...
                        tooltip: 'Clear',
                        onPressed: () async {
                          final shouldClear = await _confirmClearSentFromHistory();
  ...
  Widget _langDrop(String value, List<String> langs,
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        ...
        isExpanded: true,
        value: value,
        dropdownColor: isDark ? const Color(0xFF000000) : Colors.white,
        style: TextStyle(
            color: isDark ? Colors.white : const Color(0xFF000000),
            fontWeight: FontWeight.w600,
            fontFamily: 'monospace'),
  ...
  Widget _outBox(String label, String text, Color color, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? Colors.white12 : color.withOpacity(0.08),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isDark ? Colors.white24 : color.withOpacity(0.5),
        ),
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label,
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                style: TextButton.styleFrom(
                  foregroundColor:
                      isDark ? Colors.red : const Color(0xFF000000),
                ),
              ),
            ],
          ),
